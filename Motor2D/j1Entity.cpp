...
void j1Entity::Draw()
{
	App->render->Blit(Text, (int)fpPosition.x, (int)fpPosition.y, &currentAnimation->GetCurrentFrame(), 1.0f, Flip, 0.0f, (currentAnimation->pivotpos->x), (currentAnimation->GetCurrentFrame().h / 2));
}
